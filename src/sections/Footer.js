          ...
          <div className='col-7 d-flex flex-column align-items-center justify-content-center'>
            ...
            <div className='m-2 mt-0 mx-0'>
              <a
                ...
                href='https://www.facebook.com/masum.billah.7355079'
              >
                <FontAwesomeIcon icon={faFacebook} />
              </a>
              <a
                className='btn btn-danger m-1'
                href='https://twitter.com/Masumbillah546'
              >
                <FontAwesomeIcon icon={faTwitter} />
              </a>
              <a
                className='btn btn-danger m-1'
                href='https://www.linkedin.com/in/masum-billah-35756817b/'
              >
                <FontAwesomeIcon icon={faLinkedin} />
              </a>
              <a
                className='btn btn-danger m-1'
                href='https://www.youtube.com/channel/UC5HOZf7S1_mp88M89fdCotQ?view_as=subscriber'
              >
