...
import { faBookOpen, faBuildingColumns, faCalendar, faCalendarDays, faCertificate, faFileCircleCheck, faGraduationCap, faJ, faLocationDot, faMessage, faMobile, faPhone } from '@fortawesome/free-solid-svg-icons'
import { faBootstrap, faCss3, faFigma, faGithub, faHtml5, faLaravel, faPhp, faReact, faSquareJs, faWordpress } from '@fortawesome/free-brands-svg-icons'
      ...
      <Row id='education'>
        ...
        <div className="col-lg-8 d-flex flex-column justify-content-center p-3">
          <div style={{color: '#b4b6b5', fontSize: 20}}>
            ...
            <div className="d-flex align-items-center">
              <FontAwesomeIcon icon={faBookOpen}/>
              <div className='mx-2'>Web Application Development with PHP & Frameworks</div>
            </div>
          </div>
        </div>
      </Row>
